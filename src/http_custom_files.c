...
static const char INDEX_HTML[] =
  ...
  "async function ensureXterm(){if(xterm||xtermLoading||xtermFailed)return;xtermLoading=true;try{loadCss('https://unpkg.com/xterm@5.5.0/css/xterm.css');if(!window.Terminal)await loadScript('https://unpkg.com/xterm@5.5.0/lib/xterm.js');"
