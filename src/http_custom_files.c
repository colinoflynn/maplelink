...
static const char INDEX_HTML[] =
  ...
  "xterm=new window.Terminal({cursorBlink:true,convertEol:false,scrollback:xtermScrollback(),theme:{background:'#0b0f14',foreground:'#e6edf3'}});xterm.open(termVt);xterm.onData(d=>sendBinary(enc.encode(d)));xterm.write('\\r\\n[VT100 mode active]\\r\\n');}"
  ...
  "document.getElementById('clear').onclick=()=>{term.textContent='';hex.textContent='';hexOffset=0;lineBuf='';termCharCount=0;textLog='';rawLogChunks=[];rawLogBytes=0;pendingHexChunks=[];pendingHexBytes=0;rxChunks=[];"
